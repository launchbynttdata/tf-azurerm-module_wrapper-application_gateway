...
output "appgw_backend_address_pool_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_backend_address_pool_ids }
  description = "List of backend address pool Ids."
}

output "appgw_backend_http_settings_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_backend_http_settings_ids }
  description = "List of backend HTTP settings Ids."
}

output "appgw_backend_http_settings_probe_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_backend_http_settings_probe_ids }
  description = "List of probe Ids from backend HTTP settings."
}

output "appgw_custom_error_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_custom_error_configuration_ids }
  description = "List of custom error configuration Ids."
}

output "appgw_frontend_ip_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_frontend_ip_configuration_ids }
  description = "List of frontend IP configuration Ids."
}

output "appgw_frontend_port_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_frontend_port_ids }
  description = "List of frontend port Ids."
}

output "appgw_gateway_ip_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_gateway_ip_configuration_ids }
  description = "List of IP configuration Ids."
}

output "appgw_http_listener_frontend_ip_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_http_listener_frontend_ip_configuration_ids }
  description = "List of frontend IP configuration Ids from HTTP listeners."
}

output "appgw_http_listener_frontend_port_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_http_listener_frontend_port_ids }
  description = "List of frontend port Ids from HTTP listeners."
}

output "appgw_http_listener_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_http_listener_ids }
  description = "List of HTTP listener Ids."
}

output "appgw_id" {
  value       = { for key, value in module.app_gateway : key => value.appgw_id }
  description = "The ID of the Application Gateway."
}

output "appgw_name" {
  value       = { for key, value in module.app_gateway : key => value.appgw_name }
...
output "appgw_nsg_name" {
  value       = { for key, value in module.app_gateway : key => value.appgw_nsg_name }
...
output "appgw_public_ip_address" {
  value       = { for key, value in module.app_gateway : key => value.appgw_public_ip_address }
  description = "The public IP address of Application Gateway."
}

output "appgw_public_ip_domain_name" {
  value       = { for key, value in module.app_gateway : key => value.appgw_public_ip_domain_name }
  description = "Domain Name part from FQDN of the A DNS record associated with the public IP."
}

output "appgw_public_ip_fqdn" {
  value       = { for key, value in module.app_gateway : key => value.appgw_public_ip_fqdn }
...
output "appgw_redirect_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_redirect_configuration_ids }
  description = "List of redirect configuration Ids."
}

output "appgw_request_routing_rule_backend_address_pool_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_backend_address_pool_ids }
...
output "appgw_request_routing_rule_backend_http_settings_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_backend_http_settings_ids }
...
output "appgw_request_routing_rule_http_listener_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_http_listener_ids }
  description = "List of HTTP listener Ids attached to request routing rules."
}

output "appgw_request_routing_rule_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_ids }
  description = "List of request routing rules Ids."
}

output "appgw_request_routing_rule_redirect_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_redirect_configuration_ids }
...
output "appgw_request_routing_rule_rewrite_rule_set_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_rewrite_rule_set_ids }
...
output "appgw_request_routing_rule_url_path_map_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_request_routing_rule_url_path_map_ids }
  description = "List of URL path map Ids attached to request routing rules."
}

output "appgw_ssl_certificate_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_ssl_certificate_ids }
  description = "List of SSL certificate Ids."
  sensitive   = true
}

output "appgw_subnet_id" {
  value       = { for key, value in module.app_gateway : key => value.appgw_subnet_id }
...
output "appgw_url_path_map_default_backend_address_pool_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_url_path_map_default_backend_address_pool_ids }
...
output "appgw_url_path_map_default_backend_http_settings_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_url_path_map_default_backend_http_settings_ids }
...
output "appgw_url_path_map_default_redirect_configuration_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_url_path_map_default_redirect_configuration_ids }
  description = "List of default redirect configuration Ids attached to URL path maps."
}

output "appgw_url_path_map_ids" {
  value       = { for key, value in module.app_gateway : key => value.appgw_url_path_map_ids }
