...
output "appgw_nsg_name" {
  value       = module.app-gateway.appgw_nsg_name
...
output "appgw_redirect_configuration_ids" {
  value       = module.app-gateway.appgw_redirect_configuration_ids
  description = "List of redirect configuration Ids."
}

output "appgw_request_routing_rule_backend_address_pool_ids" {
  value       = module.app-gateway.appgw_request_routing_rule_backend_address_pool_ids
...
output "appgw_request_routing_rule_backend_http_settings_ids" {
  value       = module.app-gateway.appgw_request_routing_rule_backend_http_settings_ids
...
output "appgw_request_routing_rule_rewrite_rule_set_ids" {
  value       = module.app-gateway.appgw_request_routing_rule_rewrite_rule_set_ids
...
output "appgw_url_path_map_default_backend_address_pool_ids" {
  value       = module.app-gateway.appgw_url_path_map_default_backend_address_pool_ids
...
output "appgw_url_path_map_default_backend_http_settings_ids" {
  value       = module.app-gateway.appgw_url_path_map_default_backend_http_settings_ids
